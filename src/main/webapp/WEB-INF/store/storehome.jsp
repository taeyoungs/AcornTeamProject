    ...
    <div id="store-index">
        ...
        <section class="container store-index-section store-index-today-deal-list">
            ...
            <div class="store-index-today-deal-list__content row">
            	<c:forEach items="${dealList}" var="deal" begin="0" end="3" varStatus="i">
                    ...
                    <article class="store-index-today-deal-item">
                        ...
                        <div class="store-index-today-deal-item__image">
                            <div class="production-item-image">
                                <img class="image" src="${deal.prodImage }">
                        ...
                        <div class="store-index-today-deal-item__content">
                            <h1 class="store-index-today-deal-item__header">
                                <span class="store-index-today-deal-item__header__brand">${deal.prodSeller }</span>
                                <span class="store-index-today-deal-item__header__name">${deal.prodTitle}</span>
                            </h1>
                            <span class="production-item-price">
                                <span class="production-item-price__rate">${deal.discountRate}%</span>
            ...
            <div class="row keyword-list">
                <div class="col-6 col-md-3 keyword-wrap">
                    <a href="http://localhost:8080/store/category.do?codeVal=가구&codeSeqNo=1">
                        <div class="keyword" 
                        style="background-size: contain; background-repeat: no-repeat; background: url(/image/zipimage/zipdle0005.jpg);">
                ...
                <div class="col-6 col-md-3 keyword-wrap">
                    <a href="/store/category.do?codeVal=가전">
                        <div class="keyword" 
                        style="background-size: contain; background-repeat: no-repeat; background: url(/image/zipimage/zipdle0024.jpg);">
                ...
                <div class="col-6 col-md-3 keyword-wrap">
                    <a href="/store/ranks.do">
                        <div class="keyword" 
                        style="background-size: contain; background-repeat: no-repeat; background: url(https://bit.ly/333mMwP);">
                ...
                <div class="col-6 col-md-3 keyword-wrap">
                    <a href="#">
                        <div class="keyword" 
                        style="background-size: contain; background-repeat: no-repeat; background: url(/image/common/home_logo.png);
